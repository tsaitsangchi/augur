...
> **誠實揭露**：下列項次為 commit 後**須經非施作者**確認之核驗清單。**獨立對抗核驗＝待辦**（本檔施作者不得自填 PASS）。

| # | 核驗項 | 範圍 | 狀態 |
|---|---|---|---|
| 1 | **F-IX-3**：CS.3(a) 明示 D13/15/22/24/28 不另設 LDI 專列＋LDI.0 單向 | L6 CS.3 | ⏳ 待獨立核驗 |
| 2 | **F-IX-4**：LDO.3 目標＝`L7（L6 僅監督 UI）`；無殘留「LDO.3→L6／L7」目標欄 | L5 LDO／CS／L46 | ⏳ 待獨立核驗 |
| 3 | **F-IX-5**：L7 CS.4 覆蓋清單含誠實界限句（對齊 L6） | L7 CS.4 | ⏳ 待獨立核驗 |
| 4 | **F-IX-6**：LDO.4 目標＝純 `L7`；無「L5／L7」目標欄 | L5 LDO／CS | ⏳ 待獨立核驗 |
| 5 | **020 M2 未假關**：L7／L6 仍 honest deferred | 020／037 | ⏳ 待獨立核驗 |
| 6 | **025／029 復審日仍 2026-10-14** | 025／029 | ⏳ 待獨立核驗 |
| 7 | **lint PASS 7／7** | corpus | ⏳ 待獨立核驗 |
| 8 | **蓋章不動搖**：零 major；CK／AR／INF 版本未升 | 全案 | ⏳ 待獨立核驗 |
| 9 | **PA／五原則／MC [N] byte 零改** | `constitution/` | ⏳ 待獨立核驗 |
| 10 | **超 scope 零**：diff 限本裁決核示之 patch | git diff | ⏳ 待獨立核驗 |
...
*本裁決定案（2026-07-23；Steward **接受 Phase 3b ＋ RULING-2026-038**）。F-IX-3…6 處置閉環；蓋章不動搖。第九節獨立對抗核驗待非施作者執行。*
