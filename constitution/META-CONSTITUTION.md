...
* v1.5 → v1.6：minor／patch（Steward 裁決第 2026-040 號，AL-2026-044，2026-07-23）——§0.3 增 [I] 母集誠實註（102＝97 [N]＋5 [I] WHY）；**§0.3／§8／構成性依據之 [N] 本文一律不動**；102 計數不變；PA 與五原則本文零改；GOV-3 B 維持觀察（不升 [N]）。摘要見 Appendix I。
...
> **[I] 母集誠實註（RULING-2026-040；XRF-1）**：WM.44／RULING-017 §0.3 之「**102 條條款宇宙**」＝枚舉宇宙，組成為 **97 [N]＋5 [I] WHY（P1.Y–P5.Y）**；義務僅由 [N] 條款產生（本節既有 WHY＝[I] 句）。本註**不改** 102 計數、**不改**任何 [N] 義務外延。歷史裁決文「§8.3 之 102」為幽靈溯源**史料**（§8.3 本文無母集）——**不改**該等裁決本文；新文引用依本註＋工具層 canonical 句。
...
## Appendix I — 自 v1.5 之變更摘要（v1.6）[I]

本輪為 **minor／patch**（Steward 裁決第 2026-040 號，AL-2026-044，2026-07-23；依 §8.6「附則與 Informative 變更＝minor」；Sole Steward 授權「開 MC v1.6 最小優化」，覆蓋前裁「10-14 前不開 v1.6」之限縮）。計畫 SSOT＝`reports/augur_mc_post_ultracode_optimization_plan_20260723.md` 路徑 C 最輕量分支（§二 #3）。**PA 與五原則本文零改**；102 計數不變；**§0.3／§8／構成性依據之 [N] 本文一律不動**。

**MC 本文變更（僅 [I]／版本欄）**：
1. §0.1：版本 v1.5→**v1.6**；增本輪變更摘要指向本附錄。
2. §0.3：增 **[I] 母集誠實註**——102＝97 [N]＋5 [I] WHY；義務僅由 [N] 產生；不改計數／不改 [N]；017／026 歷史「§8.3 之 102」不改本文。

**已定案程序澄清（效力仍在裁決／[I]；本輪不升 [N]）**：
* RULING-2026-028 第 2–3 點（「參與」判準＋施作留痕／獨立核驗）持續有效——GOV-3 **已閉**於解釋通道。
* **GOV-3 B**（禁令射程入 §8.1 [N]）＝**維持觀察觸發**（028 明示不為；039 再確認）——本輪**不升格**。
* DEF-2「世界模型」邊界＝**DEFER** 至 GOV-3 B 觸發。

**明示不為（假關禁令沿用 039）**：不改 PA／五原則／§8 [N]；不重開已閉 major；不改 RULING-017／026 歷史本文；不假關 OT-5／T-KS-6／T-L6-5／025 residual／020 M2／無 Evidence 提早結清 10-14。

**全下層衝擊**：僅 L1–L7 Annex CS front-matter `mc-version` 簿記→v1.6（規格 [N] 義務句零改；同 major minor 落差依總綱 §5.4 接受）。
