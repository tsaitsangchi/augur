...
| 文件 | 角色 |
|---|---|
| [`docs/系統核心思想_v1.1.0.md`](docs/系統核心思想_v1.1.0.md) | **靈魂**：系統是什麼、為什麼、什麼絕不能違反 |
| [`docs/原則精華_v1.5.0.md`](docs/原則精華_v1.5.0.md) | **19 條不可違反原則**（三條基石：#1 / #8 / #15） |
| [`docs/系統架構大憲章_v1.5.0.md`](docs/系統架構大憲章_v1.5.0.md) | **憲法**：三個敵人 × 管線 + 12-PHASE 維運 + 升版規則 |
