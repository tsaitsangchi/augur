...
| 文件 | 角色 |
|---|---|
| [`docs/系統核心思想_v1.10.0.md`](docs/系統核心思想_v1.10.0.md) | **靈魂**：系統是什麼、為什麼、什麼絕不能違反 |
| [`docs/原則精華_v1.12.0.md`](docs/原則精華_v1.12.0.md) | **20 條不可違反原則**（三條基石：#1 / #8 / #15）＋ 資料完整性判準（as-of · FREEZE） |
| [`docs/系統架構大憲章_v1.53.0.md`](docs/系統架構大憲章_v1.53.0.md) | **憲法**：三個敵人 × 管線 + 12-PHASE 維運 + 升版規則；歷次架構/判準演進明細＝檔內「修訂歷程」（單一權威家 #12，此處不複列） |
