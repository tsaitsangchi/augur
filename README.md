...
本儲存庫封存 Augur 的 **Layer 0 元憲章（Meta-Constitution）** 與已生效之下層規格 — 約束所有後續技術規格、資料模型、程式實作與 AI Agent 行為的最高設計憲章體系。
...
| [specs/WORLD-MODEL-SPECIFICATION.md](specs/WORLD-MODEL-SPECIFICATION.md) | **Layer 1 World Model 規格 AUGUR-WM v1.0**（2026-07-16 充任認定生效） |
...
| [constitution/RULING-2026-002-LAYER1-ADOPTION.md](constitution/RULING-2026-002-LAYER1-ADOPTION.md) | Steward 裁決第 2026-002 號（Layer 1 充任認定暨同案程序） |
...
| [audits/CODE-COMPLIANCE-AUDIT-2026-07-16.md](audits/CODE-COMPLIANCE-AUDIT-2026-07-16.md) | 程式碼庫合憲審計（已驗證＋裁決定調） |
| [constitution/META-CONSTITUTION-v1.2.md](constitution/META-CONSTITUTION-v1.2.md) | v1.2 歸檔 |
...
| [specs/WORLD-MODEL-SPECIFICATION-v0.1-draft.md](specs/WORLD-MODEL-SPECIFICATION-v0.1-draft.md) | AUGUR-WM v0.1-draft 歸檔 |
