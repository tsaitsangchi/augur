...
| **FT-COV 近程** | ✅ **DASH＋EMBED CLOSED**（2026-07-28；Steward `FT-COV-DASH`＋`FT-COV-EMBED`；拍板＝`audits/FT-COV-DASH-EMBED-APPROVED-20260728.md`；收官＝`audits/FT-COV-DASH-EMBED-CLOSED-20260728.md`）——gov 終態分桶（erp 可答 **100%**，舊 length>200 假低 7% 僅對照）；庫內 CLEAN 未嵌句 gap-fill＝全 junk 入 ledger、**0 新嵌**；**不含** `HAR-ext`／pending 放量；計畫＝`reports/augur_knowledge_fulltext_coverage_plan_20260728.md` |
