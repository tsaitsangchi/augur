...
| 檔 | 是什麼 |
|---|---|
| `docs/系統核心思想_v1.7.0.md` | **靈魂**：預測**相對強弱**＋預言機軸(絕對方向機率,唯過 direction_gate;v1.6.0;v1.7.0 增輸出契約三產物含 E[r] 經濟翻譯)（非絕對漲跌機率）、成功=經濟價值非 IC、系統建議人決策、禁 AI 占卜大師 |
| `docs/原則精華_v1.9.0.md` | **20 條不可違反法律** + 資料完整性判準（**FREEZE 已解凍→live 增量維運** v1.9.0/2026-07-12） |
| `docs/系統架構大憲章_v1.44.0.md` | **憲法**：三敵×管線、12-PHASE、升版規則、**第六部計畫先行/計畫完整性 v1.39.0**、修訂歷程 |
