...
| **擴大假說／map 覆蓋** | ⏳ **計畫已出、待拍板**（2026-07-24；Steward「開擴大假說／map 覆蓋計畫」＝plan-only；`reports/augur_pme_expand_hypothesis_map_coverage_plan_20260724.md`）——mapped≈17／missing≈5／blocked_div；雙綠仍 2；建議 `MAP-P-yes`＋`MAP-E012`＋`FZ-keep`＋`GATE-keep`；**≠**解凍／≠放寬閘／≠可交易 |
