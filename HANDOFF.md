...
| **不做（近程）** | **其餘**異域進化閉環（`PME-XDOM-SOLAR` 等）仍鎖除非另拍；孫子↔**ERP dump** 自動 map 仍禁；不以顧問／RKI cite 率當 G-PROM 通過；不降閘／不解凍；AI-PREDICT／SUNZI **S3 未開**；**KNI-S2／S3 未開**；ADM-AI-ASSIST **timer 預設不 apply**（須顯式） |
