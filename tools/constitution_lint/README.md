...
> 認定上層標籤未受檢，將**逕行折抵掉真實之上層側 error**（現行實測上層側 error 為 **<!--lint:label_errors_upper-->89<!--/lint-->** 筆，
...
- **代號脫檢之殘留缺口** ~~（據實揭露，本階段未閉）~~ → ✅ **已閉（2026-07-17 三輪，G8 鎖）**：
  ...
  > （<!--lint:errors_L1-->0<!--/lint-->／<!--lint:errors_L2-->1<!--/lint-->／<!--lint:errors_L3-->31<!--/lint-->／<!--lint:errors_L4-->34<!--/lint-->／<!--lint:errors_L5-->49<!--/lint-->／<!--lint:errors_L6-->37<!--/lint-->／<!--lint:errors_L7-->48<!--/lint-->，與突變前逐格相同），**無任何規格因此翻紅或翻綠**；
...
> 本句之總 error ＝ <!--lint:total_errors-->200<!--/lint--> 即為一個活的綁定：它的 `200` 也是
...
| L2 ONTOLOGY | **<!--lint:compared_L2-->0<!--/lint-->（h1 標題致區段解析回空集）** | **<!--lint:errors_L2-->1<!--/lint-->**（非覆蓋發聲，無從歸側） | <!--lint:wm40_extension_L2-->0<!--/lint--> | <!--lint:wm44_uncited_L2-->15<!--/lint-->/<!--lint:mc_universe-->102<!--/lint--> | ❌ FAIL |
| L3 IDENTITY | <!--lint:compared_L3-->139<!--/lint-->（<!--lint:compared_mc_L3-->62<!--/lint-->／<!--lint:compared_upper_L3-->77<!--/lint-->） | **<!--lint:errors_L3-->31<!--/lint-->**（<!--lint:errors_mc_L3-->29<!--/lint-->／<!--lint:errors_upper_L3-->2<!--/lint-->） | <!--lint:wm40_extension_L3-->0<!--/lint--> | <!--lint:wm44_uncited_L3-->58<!--/lint-->/<!--lint:mc_universe-->102<!--/lint--> | ❌ FAIL |
| L4 KNOWLEDGE-SYSTEM | <!--lint:compared_L4-->168<!--/lint-->（<!--lint:compared_mc_L4-->58<!--/lint-->／<!--lint:compared_upper_L4-->110<!--/lint-->） | **<!--lint:errors_L4-->34<!--/lint-->**（<!--lint:errors_mc_L4-->32<!--/lint-->／<!--lint:errors_upper_L4-->2<!--/lint-->） | <!--lint:wm40_extension_L4-->0<!--/lint--> | <!--lint:wm44_uncited_L4-->66<!--/lint-->/<!--lint:mc_universe-->102<!--/lint--> | ❌ FAIL |
| L5 COGNITIVE-KERNEL | <!--lint:compared_L5-->100<!--/lint-->（<!--lint:compared_mc_L5-->55<!--/lint-->／<!--lint:compared_upper_L5-->45<!--/lint-->） | **<!--lint:errors_L5-->49<!--/lint-->**（<!--lint:errors_mc_L5-->27<!--/lint-->／<!--lint:errors_upper_L5-->22<!--/lint-->） | <!--lint:wm40_extension_L5-->0<!--/lint--> | <!--lint:wm44_uncited_L5-->16<!--/lint-->/<!--lint:mc_universe-->102<!--/lint--> | ❌ FAIL |
| L6 AGENT-RUNTIME | <!--lint:compared_L6-->83<!--/lint-->（<!--lint:compared_mc_L6-->50<!--/lint-->／<!--lint:compared_upper_L6-->33<!--/lint-->） | **<!--lint:errors_L6-->37<!--/lint-->**（<!--lint:errors_mc_L6-->21<!--/lint-->／<!--lint:errors_upper_L6-->16<!--/lint-->） | <!--lint:wm40_extension_L6-->0<!--/lint--> | <!--lint:wm44_uncited_L6-->16<!--/lint-->/<!--lint:mc_universe-->102<!--/lint--> | ❌ FAIL |
...
合計比對 **<!--lint:compared_total-->641<!--/lint--> 筆**（MC **<!--lint:compared_mc-->296<!--/lint-->**／上層規格 **<!--lint:compared_upper-->345<!--/lint-->**）。

error 合計 **<!--lint:total_errors-->200<!--/lint--> 筆**：**MC 側 <!--lint:label_errors_mc-->110<!--/lint-->／上層側
<!--lint:label_errors_upper-->89<!--/lint-->／未歸類 <!--lint:label_errors_unclassified-->1<!--/lint-->**（三項並列；
...
> 不可混用（<!--lint:compared_total-->641<!--/lint-->/<!--lint:compared_mc-->296<!--/lint-->/<!--lint:compared_upper-->345<!--/lint--> 屬前者，<!--lint:total_errors-->200<!--/lint-->/<!--lint:label_errors_mc-->110<!--/lint-->/<!--lint:label_errors_upper-->89<!--/lint-->/<!--lint:label_errors_unclassified-->1<!--/lint--> 屬後者）；`report` 將二者分列於不同區塊，勿跨區相加。

分型（取自 finding 之 `kind` 欄，**於生成處指定、非事後 grep 訊息反推**；合計
<!--lint:total_errors-->200<!--/lint-->）：括號名全然不符 **<!--lint:kind_paren_mismatch-->114<!--/lint-->**／
無自有標籤且正文無支撐 **<!--lint:kind_no_text_support-->45<!--/lint-->**／
`X（Y）` 截半名 **<!--lint:kind_halved_name-->29<!--/lint-->**／
前段截取 **<!--lint:kind_leading_truncation-->11<!--/lint-->**／
Annex TR 非覆蓋發聲 **<!--lint:kind_tr_absent-->1<!--/lint-->**。

> **前版記「括號名全然不符 27」，實為 <!--lint:kind_paren_mismatch-->114<!--/lint-->** —— 差額之來源即判準 4 之無條件大赦：該型之漏網者
> （如 `P1.E1`）從未計入其所報之清單。**此為本輪最大之單項低估（27 → <!--lint:kind_paren_mismatch-->114<!--/lint-->；「27」為前版之歷史值，不綁定）。**
...
**逐字一致且經 gate 判為誤標**之「代號＋標籤」對計 **<!--lint:dup_mislabels-->31<!--/lint--> 組**；
其中 **<!--lint:dup_mislabels_in_4-->7<!--/lint--> 組橫跨全部四份**：
...
| 份數 | 組數 | 代號 | 逐字複製之誤標 |
|---|---|---|---|
| **4**（L3/L4/L5/L6） | <!--lint:dup_mislabels_in_4-->7<!--/lint--> | `P4.E1`…`P4.E6`、`§8.2` | 「五元組最低不變式」「雙時間、as-of 重建」「只失效不刪除、tombstone」「可謬性、禁隱含 1.0」「矛盾保存、禁 LWW」「遞迴溯源、禁循環」「違憲審查」 |
| **3** | <!--lint:dup_mislabels_in_3-->3<!--/lint--> | `P4.E7`、`P4.E8`、`§8.3` | 「NoLaundering、獨立性、synthetic、高風險證據」等 |
| **2** | <!--lint:dup_mislabels_in_2-->21<!--/lint--> | `F4`（L5/L6）、`P1.E3`（L3/L4）、`P1.W1`（L3/L4）、`P5.W4`／`P5.W5`（L3/L4）等 | 「公理金字塔／演化鏈總述」「來源崇拜警語」… |
...
> **論點不因此動搖而更強**：全域導出之複製誤標為 **<!--lint:dup_mislabels-->31<!--/lint--> 組**
