...
代號合憲章編號形態卻不在條款宇宙（97 [N]＋5 [I] WHY；WM.44／RULING-017 §0.3）者 → ERROR（非誤植即杜撰）；前綴屬已知規格但未列於
...
- **條款宇宙之已知邊界（據實揭露）**：現行母集 **<!--lint:mc_universe-->102<!--/lint--> 條**＝PA／P#.*／EV.1–12／F1–F6／[N] 章（§0–§8）／
  ...
  **字母項（`§0.6(a)`、`§8.5(b)(i)`）未納入**：`§0.3` 稱「章節號及其小節與**項次**視同條款編號」，
  ...
  依 `§8.1` 屬 Steward 專屬——linter 不得自行造法。此為**明示保留〔**2026-07-18 更新**：此爭點已由 RULING-2026-017 §8.1 裁定——字母／羅馬子項屬「項次」受編號穩定性保護、**但不計入 102 母集**（保護 ≠ 計數）；§5.{n} 入母集。故現行 102 為裁定值，非未決〕**，非疏漏；如經 Steward 解釋
...
- **代號脫檢之殘留缺口** ~~（據實揭露，本階段未閉）~~ → ✅ **已閉（2026-07-17 三輪，G8 鎖）**：
  ...
  > 新增者全為 **WARNING**（ID 1→<!--lint:warnings_L3-->0<!--/lint-->、KS 9→<!--lint:warnings_L4-->0<!--/lint-->、L5 7→<!--lint:warnings_L5-->0<!--/lint-->；箭頭左側為突變前之歷史值，不綁定），內容為 Annex TR 中**他文件之代號**
...
|---|---|---|---|---|---|
| L1 WORLD-MODEL | <!--lint:compared_L1-->0<!--/lint-->（確無 Annex TR → INFO「不適用」） | <!--lint:errors_L1-->0<!--/lint--> | <!--lint:wm40_extension_L1-->0<!--/lint--> | <!--lint:wm44_uncited_L1-->0<!--/lint-->/<!--lint:mc_universe-->102<!--/lint--> | ✅ PASS |
| L2 ONTOLOGY | <!--lint:compared_L2-->4<!--/lint-->（Annex TR h1→h2 正規化入檢＝RULING-010／#22；RULING-021 補列 4 群） | **<!--lint:errors_L2-->0<!--/lint-->**（標籤全對、窮舉補列） | <!--lint:wm40_extension_L2-->0<!--/lint--> | <!--lint:wm44_uncited_L2-->0<!--/lint-->/<!--lint:mc_universe-->102<!--/lint--> | ✅ PASS |
| L3 IDENTITY | <!--lint:compared_L3-->193<!--/lint-->（<!--lint:compared_mc_L3-->70<!--/lint-->／<!--lint:compared_upper_L3-->123<!--/lint-->） | **<!--lint:errors_L3-->0<!--/lint-->**（<!--lint:errors_mc_L3-->0<!--/lint-->／<!--lint:errors_upper_L3-->0<!--/lint-->） | <!--lint:wm40_extension_L3-->0<!--/lint--> | <!--lint:wm44_uncited_L3-->0<!--/lint-->/<!--lint:mc_universe-->102<!--/lint--> | ✅ PASS |
| L4 KNOWLEDGE-SYSTEM | <!--lint:compared_L4-->214<!--/lint-->（<!--lint:compared_mc_L4-->66<!--/lint-->／<!--lint:compared_upper_L4-->148<!--/lint-->） | **<!--lint:errors_L4-->0<!--/lint-->**（<!--lint:errors_mc_L4-->0<!--/lint-->／<!--lint:errors_upper_L4-->0<!--/lint-->） | <!--lint:wm40_extension_L4-->0<!--/lint--> | <!--lint:wm44_uncited_L4-->0<!--/lint-->/<!--lint:mc_universe-->102<!--/lint--> | ✅ PASS |
| L5 COGNITIVE-KERNEL | <!--lint:compared_L5-->125<!--/lint-->（<!--lint:compared_mc_L5-->55<!--/lint-->／<!--lint:compared_upper_L5-->70<!--/lint-->） | **<!--lint:errors_L5-->0<!--/lint-->**（<!--lint:errors_mc_L5-->0<!--/lint-->／<!--lint:errors_upper_L5-->0<!--/lint-->） | <!--lint:wm40_extension_L5-->0<!--/lint--> | <!--lint:wm44_uncited_L5-->0<!--/lint-->/<!--lint:mc_universe-->102<!--/lint--> | ✅ PASS |
| L6 AGENT-RUNTIME | <!--lint:compared_L6-->84<!--/lint-->（<!--lint:compared_mc_L6-->50<!--/lint-->／<!--lint:compared_upper_L6-->34<!--/lint-->） | **<!--lint:errors_L6-->0<!--/lint-->**（<!--lint:errors_mc_L6-->0<!--/lint-->／<!--lint:errors_upper_L6-->0<!--/lint-->） | <!--lint:wm40_extension_L6-->0<!--/lint--> | <!--lint:wm44_uncited_L6-->0<!--/lint-->/<!--lint:mc_universe-->102<!--/lint--> | ✅ PASS |
| L7 INFRASTRUCTURE | <!--lint:compared_L7-->142<!--/lint-->（<!--lint:compared_mc_L7-->71<!--/lint-->／<!--lint:compared_upper_L7-->71<!--/lint-->） | **<!--lint:errors_L7-->0<!--/lint-->**（<!--lint:errors_mc_L7-->0<!--/lint-->／<!--lint:errors_upper_L7-->0<!--/lint-->） | <!--lint:wm40_extension_L7-->0<!--/lint--> | <!--lint:wm44_uncited_L7-->0<!--/lint-->/<!--lint:mc_universe-->102<!--/lint--> | ✅ PASS |

合計比對 **<!--lint:compared_total-->762<!--/lint--> 筆**（MC **<!--lint:compared_mc-->316<!--/lint-->**／上層規格 **<!--lint:compared_upper-->446<!--/lint-->**）。
...
> 不可混用（<!--lint:compared_total-->762<!--/lint-->/<!--lint:compared_mc-->316<!--/lint-->/<!--lint:compared_upper-->446<!--/lint--> 屬前者，<!--lint:total_errors-->0<!--/lint-->/<!--lint:label_errors_mc-->0<!--/lint-->/<!--lint:label_errors_upper-->0<!--/lint-->/<!--lint:label_errors_unclassified-->0<!--/lint--> 屬後者）；`report` 將二者分列於不同區塊，勿跨區相加。
