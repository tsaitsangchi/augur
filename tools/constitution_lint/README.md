...
合計比對 **<!--lint:compared_total-->637<!--/lint--> 筆**（MC **<!--lint:compared_mc-->300<!--/lint-->**／上層規格 **<!--lint:compared_upper-->337<!--/lint-->**）。
...
> 不可混用（<!--lint:compared_total-->637<!--/lint-->/<!--lint:compared_mc-->300<!--/lint-->/<!--lint:compared_upper-->337<!--/lint--> 屬前者，<!--lint:total_errors-->0<!--/lint-->/<!--lint:label_errors_mc-->0<!--/lint-->/<!--lint:label_errors_upper-->0<!--/lint-->/<!--lint:label_errors_unclassified-->0<!--/lint--> 屬後者）；`report` 將二者分列於不同區塊，勿跨區相加。
