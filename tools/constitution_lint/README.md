...
- **代號脫檢之殘留缺口** ~~（據實揭露，本階段未閉）~~ → ✅ **已閉（2026-07-17 三輪，G8 鎖）**：
  ...
  > 新增者全為 **WARNING**（ID 1→<!--lint:warnings_L3-->0<!--/lint-->、KS 9→<!--lint:warnings_L4-->0<!--/lint-->、L5 7→<!--lint:warnings_L5-->1<!--/lint-->；箭頭左側為突變前之歷史值，不綁定），內容為 Annex TR 中**他文件之代號**
...
| L5 COGNITIVE-KERNEL | <!--lint:compared_L5-->124<!--/lint-->（<!--lint:compared_mc_L5-->55<!--/lint-->／<!--lint:compared_upper_L5-->69<!--/lint-->） | **<!--lint:errors_L5-->0<!--/lint-->**（<!--lint:errors_mc_L5-->0<!--/lint-->／<!--lint:errors_upper_L5-->0<!--/lint-->） | <!--lint:wm40_extension_L5-->0<!--/lint--> | <!--lint:wm44_uncited_L5-->0<!--/lint-->/<!--lint:mc_universe-->102<!--/lint--> | ✅ PASS |
...
合計比對 **<!--lint:compared_total-->761<!--/lint--> 筆**（MC **<!--lint:compared_mc-->316<!--/lint-->**／上層規格 **<!--lint:compared_upper-->445<!--/lint-->**）。
...
> 不可混用（<!--lint:compared_total-->761<!--/lint-->/<!--lint:compared_mc-->316<!--/lint-->/<!--lint:compared_upper-->445<!--/lint--> 屬前者，<!--lint:total_errors-->0<!--/lint-->/<!--lint:label_errors_mc-->0<!--/lint-->/<!--lint:label_errors_upper-->0<!--/lint-->/<!--lint:label_errors_unclassified-->0<!--/lint--> 屬後者）；`report` 將二者分列於不同區塊，勿跨區相加。
