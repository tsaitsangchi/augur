...
description: 哲學素養框架(06-30 相容版 v1.16.0 → 07-01 擴博學 v1.17.0 → 07-02 版權合規路 v1.18.0)— augur「博學投資大師 AI」;投資哲學=因子假說來源、廣博哲學=解讀素養層、明文從屬三敵;素養庫(⚠數字 2026-07-17 實查已成長:thinker **4,135**/work **1,536**/work_text **618** distinct works/chunk 126,609 嵌入覆蓋 100%;原 861/699/572 為 07-02 建錨值)
metadata:
  node_type: memory
  type: project
