...
- **程式**：`src/augur/` **18 package**——advisor・arena・audit・catalog・core・deliberation・evaluation・evolution・execution・features・identity・ingestion・knowledge・models・philosophy・universe（舊記憶寫「15 package／193 scripts」已過期；`scripts/` 受指令矩陣稽核者 **425 支**）。
