...
**關鍵不變式**:COST 0.00585 · embargo 62td/H禁252 · trial_ledger N=count DISTINCT(model,top_frac,weight,feats_hash,cost,horizon) · DSR per-period · release_lag 15/45/90 · missing-row 不 fake · feats_hash sha256 sorted[:16] · guard 五閘+誠實閉集二句(變更=憲章)· license 5 白名單三同步 · as-of 2026-05-31 FREEZE。
