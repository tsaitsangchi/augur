...
| **F-U-PME-6** | 靈魂已修謊言 | **pass（仍 pending）** | **文本**：計畫／拍板／DEFAULT `soul_wording_pending=True`；run5 `soul=true`。**形式**：無 audits／plans 句稱「已修非自動駕駛 [N]」。**實務**：AUTO-B 張力知情未關。 | **維持 G-PME-SOUL=pending** |
...
| G-PME-SOUL | **維持 pending** | 未改 [N]；未謊稱已解 |
