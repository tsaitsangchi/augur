...
| 4 | World Understanding Engine | **Cognitive Kernel 自研**（augur-code：deliberation／verifiers／core_gate；模型輔助＝ollama qwen3:4b/8b，CPU-only） | (3) 之「版本」＝git SHA（活服務跑 /home/hugo 副本——**雙副本現實使版本錨定不唯一，為缺口**）；缺 (4)(5)(6) |
