...
🎯 這支在做什麼(白話):H 軌 v2 的個股月頻特徵層——每「月末交易日」×「最近相對 panel 之宇宙股」一組:
   ...
   lag-1 值位移);rank_pctile_h{5,10,20,40,60,90,240}(probability_oos_sample 最近 as-of panel 之相對強弱,**如實陳舊**:
...
from augur.core.closed_horizons import H_MONTHLY_RANKS

ADJ_CONCEPT = "tw.daily_bar_adjusted"  # WM.36
START, FREEZE = "2017-01-01", "2026-05-31"  # FREEZE=完整性定案錨；--until 預設=價頂
H_RANKS = H_MONTHLY_RANKS  # 月頻相對分位；H90 取代 H82（2026-08-14）
