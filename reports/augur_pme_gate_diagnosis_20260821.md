# PME 閘診斷帳 [I]（2026-08-21）

* run_id=35 · as_of=2026-08-21T06:43:57Z · 唯讀 · FZ-keep／GATE-keep
* coverage_tallies={'missing': 14, 'mapped': 36, 'blocked_div': 1}
* gate_cross={'FAIL×FAIL': 30, 'FAIL×PASS': 16, 'FAIL_SIGN×FAIL': 8, 'PASS×FAIL': 17, 'PASS×PASS': 5, 'SKIP×SKIP': 15}
* unmapped_in_fv n=1
* econ_only_features=['dollar_volume_log_20d', 'inst_cumflow_position_60d', 'institutional_net_buy_ratio_20d', 'lending_fee_rate_mean_20d', 'range_position_120d']
...
|---|---|---|---|---|
| `close_x_sbl_balance_level` | missing | 1 | False | unknown |
| `cycle_position_252d` | mapped | 2 | True | n/a |
| `days_since_high_126d` | missing | 1 | False | unknown |
| `days_since_high_252d` | mapped | 6 | True | n/a |
| `days_since_high_252d_raw` | missing | 1 | False | unknown |
| `debt_ratio` | mapped | 5 | True | db_buildable |
| `dividend_yield` | blocked_div | 1 | True | unknown |
| `dollar_volume_log_20d` | mapped | 1 | True | n/a |
| `foreign_holding_pct` | mapped | 4 | True | n/a |
| `gov_bank_net_buy_60d` | mapped | 2 | True | n/a |
| `gross_margin_pctile` | mapped | 5 | True | n/a |
| `inst_cumflow_position_120d` | mapped | 1 | True | n/a |
| `inst_cumflow_position_60d` | mapped | 2 | True | n/a |
| `inst_gross_x_money_change` | missing | 1 | False | unknown |
| `inst_gross_x_turnover_change` | missing | 1 | False | unknown |
| `inst_gross_x_turnover_level` | missing | 1 | False | unknown |
| `inst_gross_x_volume_change` | missing | 1 | False | unknown |
| `inst_gross_x_volume_level` | missing | 1 | False | unknown |
| `institutional_net_buy_ratio_20d` | mapped | 7 | True | n/a |
| `lending_fee_rate_mean_20d` | mapped | 1 | True | n/a |
| `lending_fee_rate_mean_30d` | mapped | 1 | True | n/a |
| `lending_fee_vw_mean_20d` | missing | 1 | False | unknown |
| `log1p_days_since_high_252d` | missing | 1 | False | unknown |
| `macro_regime` | missing | 1 | False | blocked_fz |
| `market_cap_log` | mapped | 1 | True | n/a |
| `market_value_x_revenue_level` | missing | 1 | False | unknown |
| `momentum_120d` | mapped | 3 | True | n/a |
| `momentum_20d` | mapped | 3 | True | n/a |
| `momentum_252d` | mapped | 1 | True | n/a |
| `momentum_5d` | mapped | 1 | True | n/a |
| `momentum_60d` | mapped | 5 | True | n/a |
| `monthly_revenue_yoy` | mapped | 5 | True | n/a |
| `pb_ratio` | mapped | 3 | True | n/a |
| `pe_ratio` | mapped | 6 | True | n/a |
...
| `range_mean_20d` | mapped | 4 | True | n/a |
| `range_position_120d` | mapped | 5 | True | n/a |
| `return_1d` | mapped | 1 | True | n/a |
| `roe` | mapped | 5 | True | db_buildable |
| `sbl_short_balance_log` | mapped | 1 | True | n/a |
| `top_holders_pct` | mapped | 2 | True | n/a |
| `turnover_mean_20d` | mapped | 1 | True | n/a |
| `volatility_60d` | mapped | 5 | True | n/a |
