...
**發現**:**IC 隨 horizon 單調上升**(Ridge H60 +0.141→H120 +0.152;GBDT +0.112→+0.149、增 33%)——這批特徵(估值/循環/相位)是**長 horizon 訊號**,現用 H20/H60 低估 alpha。長 horizon 兼**低換手→低成本**→ 經濟價值或大幅更好。**首個逃脫飽和方向(換問題、非加特徵)**。caveat:H252 重疊窗多須 HAC 複核;經濟回測需非重疊(年/半年)再平衡。**待**:H120/252 非重疊經濟回測 + 宇宙掃描(core 848 vs 擴大 3080)。工具 `run_horizon_universe_scan.py`。
