# SUNSET (a) 裁定之證據整備 [呈案] ＋ 裁決結果（2026-07-31）

> ## ⚖ 裁決已作成（2026-07-31 19:45:26，Steward hugo TTY 親簽）
>
> ```
> V2-SUNSET-r2  status=evaluated_pass  evaluated_at=2026-07-31 19:45:26+08
> ruled_by=hugo   ruling_basis=R1「任一 direction_gate 列有可讀之數」
> consequence_executed=false
> ```
>
> **Steward 採 R1，裁 (a) 達成 ⇒ SUNSET 1/3 ⇒ 三軸續命。** 依 `AUGUR-MC v1.6 §8.1`，
> 條文解釋權專屬 Steward，本裁決為終局；該列自此為終態，trigger 拒絕一切後續 UPDATE。
>
> **本檔之 §二～§六為裁決前之證據整備，其結論（傾向 R2／R3、即 (a) 未達成）與本裁決不同。**
> **二者一併保留、不予刪改**——證據是證據，裁決是裁決；預註冊機制之意義即在於
> 「證據被完整記錄，而由人裁」。日後引用本檔者**不得以 §二～§六冒充裁決**，
> 亦不得因裁決已作成而刪去與之相左之證據（#15 判死留檔之對偶）。
>
> **一項前瞻事實（陳述，非對裁決之異議）**：R1 之判定依據包含 2026-07-11 那批
> `evaluated_fail` 之 `result_snapshot`，而該等快照為**不可變史料**。
> ⇒ 任何**沿用 (a) 現行文字**之未來閘，其 (a) 分支將**於凍結瞬間即已滿足且永遠滿足**。
> 若欲使後續停損閘具鑑別力，新閘之判準須改寫（見 §六「另開有牙齒之新閘」）。
