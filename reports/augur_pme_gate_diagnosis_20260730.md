# PME 閘診斷帳 [I]（2026-07-30）

* run_id=10 · as_of=2026-07-30T15:00:01Z · 唯讀 · FZ-keep／GATE-keep
* coverage_tallies={'missing': 14, 'mapped': 36, 'blocked_div': 1}
* gate_cross={'ABSENT×ABSENT': 1}
* unmapped_in_fv n=1
* econ_only_features=[]
...
| `debt_ratio` | mapped | 4 | True | db_buildable |
...
| `gross_margin_pctile` | mapped | 4 | True | n/a |
...
| `institutional_net_buy_ratio_20d` | mapped | 6 | True | n/a |
...
| `monthly_revenue_yoy` | mapped | 4 | True | n/a |
| `pb_ratio` | mapped | 3 | True | n/a |
| `pe_ratio` | mapped | 5 | True | n/a |
