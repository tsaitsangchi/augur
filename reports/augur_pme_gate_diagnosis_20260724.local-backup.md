...
* run_id=1 · as_of=2026-07-24T14:55:33Z · 唯讀 · FZ-keep／GATE-keep
* coverage_tallies={'mapped': 35, 'blocked_div': 1, 'missing': 3}
* gate_cross={'FAIL×FAIL': 33, 'FAIL×PASS': 18, 'PASS×FAIL': 1, 'PASS×PASS': 2, 'SKIP×SKIP': 4}
* unmapped_in_fv n=1
* econ_only_features=['cycle_position_252d', 'days_since_high_252d', 'gov_bank_net_buy_60d', 'institutional_net_buy_ratio_20d', 'lending_fee_rate_mean_30d', 'price_to_252d_high', 'range_position_120d', 'return_1d', 'turnover_mean_20d']
...
- `gov_bank_net_buy_60d`
- `institutional_net_buy_ratio_20d`
- `lending_fee_rate_mean_30d`
- `price_to_252d_high`
- `range_position_120d`
- `return_1d`
- `turnover_mean_20d`
