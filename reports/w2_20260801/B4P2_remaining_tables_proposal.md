...
- P2a（6 表；kill_switch 依 §5 另裁）：**同意**（Steward 圈選 via 對話 2026-08-02）
- §5 kill_switch（甲／乙）：**乙**（排除；緊急煞車零摩擦優先）
- P2b（6 表；run 21 後窗）：**同意、run 21 結輪後開窗**
- P2c（sim 七表；建議緩議）：**緩議**（歸 sim 專章）
- 裁決編號：**併 RULING-2026-043**（B4 翻案族執行分批）　簽署：（圈選=對話留痕；DDL 窗驗收後回呈）　日期：2026-08-02
