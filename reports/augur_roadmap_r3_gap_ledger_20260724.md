...
| G-R7-1 | R7 §4.1／U7 | 產品閘哨兵＝結構／禁語抽樣；≠語義核准／PRODSET／Dividend 完備 | `verify_roadmap_r7_gate.py` | **U7 2026-07-24**：`--check` P-PME fail=0＝真結構綠；空殼「四判準」＋「生產特徵集已登錄」／「Dividend 完備」句仍可 PASS（字面遊戲）。見 `audits/ROADMAP-U7-R7-ULTRACODE-20260724.md` F-U7-1／5 | **doc-only** | 知情；語義屬 U7／人裁；PRODSET 另案；勿讀成 none＝計畫已審完 |
...
| R7 產品閘哨兵能力邊界 | G-R7-1 | **doc-only**（U7：結構綠≠語義／PRODSET／Dividend 完備閘） |
...
* ✅ **U7 已跑**（2026-07-24；`audits/ROADMAP-U7-R7-ULTRACODE-20260724.md`）——R7 S1＋S2＋U7 可呈核；**禁** PME-Efull／八產品出貨／可交易；新列 **G-R7-1 doc-only**；G-PME-PRODSET 維持 partial（交叉 U-PME）
