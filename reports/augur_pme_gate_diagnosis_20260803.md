# PME 閘診斷帳 [I]（2026-08-03）

* run_id=21 · as_of=2026-08-03T15:00:02Z · 唯讀 · FZ-keep／GATE-keep
* coverage_tallies={'missing': 14, 'mapped': 36, 'blocked_div': 1}
* gate_cross={'FAIL×FAIL': 58, 'FAIL×PASS': 7, 'FAIL_SIGN×FAIL': 16, 'PASS×FAIL': 12, 'PASS×PASS': 3, 'SKIP×SKIP': 15}
* unmapped_in_fv n=1
* econ_only_features=['dollar_volume_log_20d', 'foreign_holding_pct', 'price_to_252d_high', 'turnover_mean_20d']
