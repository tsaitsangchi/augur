...
* 狀態留痕：`audits/PME-S012-STATUS-20260724.md`；**E123**：`audits/PME-E123-STATUS-20260724.md`；**U-PME**：`audits/PME-ULTRACODE-20260724.md`
* 性質：[I]；**不**創設 [N]
...
| **G-PME-STATUS** | known／open | **partial** | validated=2；desync=21；禁假翻（U-PME 再驗） |
