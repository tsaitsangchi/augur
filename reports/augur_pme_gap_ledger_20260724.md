...
| **G-PME-ECON** | open／SKIP | **partial** | E123＋再晉升 run6：PASS=15／FAIL=21／SKIP=6（同統計）；非 skeleton；無新雙綠 |
| **G-PME-PROM** | open／SKIP | **partial** | E123＋再晉升 run6：PASS=2／FAIL=34／SKIP=6（同統計）；U-PME＝非 Goodhart；active 未擴大 |
...
| **G-PME-PRODSET** | partial | **none** | **PRODSET CLOSED 2026-07-24**：真寫 `evolution_production_feature_set`；APPLY／`--backfill-prodset`；run5→run6 再 APPLY×2 active（未擴大）；`audits/PME-PRODSET-CLOSED-20260724.md`／`PME-LOCAL-REPROMOTE-20260724.md`；**≠**可交易／確立級 |
...
| **G-PME-HOTPATH** | open | **none** | **S123＋U-P2H DONE 2026-07-24**：train／predict 真讀 prodset（`P2H-E123`＋FC-empty）；`audits/P2H-S123-CLOSED-20260724.md`＋`audits/P2H-ULTRACODE-20260724.md`；n_feats=2 誠實極窄；**再晉升 run6 未擴大**（`PME-LOCAL-REPROMOTE-20260724.md`）；**重訓確認穩定**（`PME-REPROMOTE-RETRAIN-20260724.md`；rows=12034）；**≠**可交易／確立級 |
