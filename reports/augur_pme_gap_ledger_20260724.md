...
| **G-PME-HOTPATH** | open | **none** | **S123＋U-P2H DONE 2026-07-24**：train／predict 真讀 prodset（`P2H-E123`＋FC-empty）；`audits/P2H-S123-CLOSED-20260724.md`＋`audits/P2H-ULTRACODE-20260724.md`；n_feats=2 誠實極窄；**再晉升 run6 未擴大**（`PME-LOCAL-REPROMOTE-20260724.md`）；**≠**可交易／確立級 |
