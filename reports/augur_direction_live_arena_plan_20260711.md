...
| # | 拍板 | 性質 |
|---|---|---|
| A-1 | 本計畫書(含:arena verdict 新閉集字彙、judgestop CHECK 是否擴 'ARENA' 或另表〔本計畫採**另表**〕、TAIEX=內部分量永不展示) | 現在 |
| A-2 | **as-of' 值與解凍時點+完整修憲清單**(§1;本計畫最大拍板)+ **prereg-at-A2 之 no-v3 相容裁定**(§1) | 解凍決策 |
