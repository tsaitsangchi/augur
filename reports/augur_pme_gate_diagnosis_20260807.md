# PME 閘診斷帳 [I]（2026-08-07）

* run_id=25 · as_of=2026-08-07T15:00:01Z · 唯讀 · FZ-keep／GATE-keep
* coverage_tallies={'missing': 14, 'mapped': 36, 'blocked_div': 1}
* gate_cross={'FAIL×FAIL': 53, 'FAIL×PASS': 8, 'FAIL_SIGN×FAIL': 15, 'PASS×FAIL': 17, 'PASS×PASS': 3, 'SKIP×SKIP': 15}
* unmapped_in_fv n=1
* econ_only_features=['dollar_volume_log_20d', 'foreign_holding_pct', 'lending_fee_rate_mean_20d', 'price_to_252d_high', 'turnover_mean_20d']
