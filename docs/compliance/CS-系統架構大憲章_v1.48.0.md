# Constitutional Compliance Statement — 系統架構大憲章 v1.48.0
...
* **正文 SSOT**：v1.48.0 正文續改為現行 `docs/系統架構大憲章_v1.49.0.md`（同一檔案沿革，v1.48.0 無獨立檔）；本聲明僅覆蓋 v1.48.0 之增量，現行版聲明見 `docs/compliance/CS-系統架構大憲章_v1.49.0.md`。
...
compliance-statement:
  ...
  archive-path: docs/compliance/CS-系統架構大憲章_v1.48.0.md
```
