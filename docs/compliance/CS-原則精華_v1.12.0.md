...
* **open-tension（新增，不假關）**：~~**T-PRIN-20-VERSIONING**~~ → **已關閉（2026-07-30）**：hugo 拍板「通則二-照案」入憲大憲章 v1.51.0 第六部「變更等級認定原則（放寬從嚴）」，依其 (a)(c) 該次改寫（新增人閘豁免＝放寬類）**認定為重大判準修正**、已於 v1.11.0 補記列載明應追認為獨立 minor 版。**本 open-tension 據此關閉，非假關**。
