...
**位階**〔2026-07-30 機械軌：領域大憲章亦定版為 `docs/系統架構大憲章_v1.53.0.md`；另本檔「憲章」一詞兼指元憲章（`AUGUR-MC v1.6`）與領域大憲章，**引用時一律加前綴以免歧義**〕：系統 doctrine 以 `docs/系統核心思想_v1.10.0.md`（靈魂） + `docs/原則精華_v1.12.0.md` + 憲章為準；
