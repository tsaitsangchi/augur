# CLAUDE.md — Augur AI 協作工具規則 v1.32（含 P11 續批）
...
> **條號導讀**：條號按「**新增順序**」編、按「**分類**」歸章，故**非連續**——一 `#1-8`（通用）· 二 `#9-12, 32`（資料真實）· 三 `#13-20, 29`（編輯規則）· 四 `#21-25, 28, 30, 31`（long-running）· 五 `#26-27`（協作模式）。
